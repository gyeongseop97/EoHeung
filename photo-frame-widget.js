(function(){
  ...
  const FRAME_ASSET_VERSION='frame20260616f';
  const SRC={
  ...
  const TEXT_POS={
    '16:9|landscape':{ref:[1635,927],font:22,date:{x:271,y:884,w:160},opponent:{x:597,y:884,w:175},scoreHome:{x:829,y:884,w:45},scoreAway:{x:896,y:884,w:45},cheer:{x:1078,y:884,w:250},location:{x:1450,y:884,w:260}},
    '16:9|portrait':{ref:[979,1533],font:24,date:{x:280,y:1404,w:270},opponent:{x:775,y:1404,w:300},scoreHome:{x:219,y:1446,w:95},scoreAway:{x:349,y:1446,w:95},cheer:{x:705,y:1446,w:450},location:{x:560,y:1484,w:760}},
    '1:1|landscape':{ref:[1242,1245],font:20,date:{x:240,y:1188,w:120},opponent:{x:472,y:1188,w:115},scoreHome:{x:635,y:1188,w:42},scoreAway:{x:688,y:1188,w:42},cheer:{x:823,y:1188,w:205},location:{x:1092,y:1188,w:225}},
    '1:1|portrait':{ref:[1242,1245],font:20,date:{x:240,y:1188,w:120},opponent:{x:472,y:1188,w:115},scoreHome:{x:635,y:1188,w:42},scoreAway:{x:688,y:1188,w:42},cheer:{x:823,y:1188,w:205},location:{x:1092,y:1188,w:225}},
    '4:3|landscape':{ref:[1426,1072],font:21,date:{x:247,y:1015,w:135},opponent:{x:519,y:1015,w:145},scoreHome:{x:705,y:1015,w:44},scoreAway:{x:766,y:1015,w:44},cheer:{x:926,y:1015,w:235},location:{x:1290,y:1015,w:245}},
    '4:3|portrait':{ref:[1074,1444],font:23,date:{x:307,y:1332,w:310},opponent:{x:835,y:1332,w:335},scoreHome:{x:224,y:1369,w:95},scoreAway:{x:351,y:1369,w:95},cheer:{x:766,y:1369,w:500},location:{x:604,y:1406,w:820}}
  };
  ...
  function drawText(c,w,h){let cfg=textCfg(w,h),t=gameTexts(),fs=cfg.font;fit(c,t.date,cfg.date.x,cfg.date.y,cfg.date.w,fs);fit(c,t.opponent,cfg.opponent.x,cfg.opponent.y,cfg.opponent.w,fs);fit(c,t.scoreHome,cfg.scoreHome.x,cfg.scoreHome.y,cfg.scoreHome.w,fs);fit(c,t.scoreAway,cfg.scoreAway.x,cfg.scoreAway.y,cfg.scoreAway.w,fs);fit(c,t.cheer,cfg.cheer.x,cfg.cheer.y,cfg.cheer.w,Math.round(fs*.92));fit(c,t.location,cfg.location.x,cfg.location.y,cfg.location.w,Math.round(fs*.82))}
